-- Add enhanced funding info columns to subsidies table (where the actual data is)
...
CREATE INDEX IF NOT EXISTS idx_subsidies_enhanced_funding 
ON public.subsidies USING gin(enhanced_funding_info);
