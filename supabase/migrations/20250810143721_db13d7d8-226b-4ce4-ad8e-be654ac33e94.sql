...
BEGIN
  ...
  LOOP
    ...
    -- PERMISSIVE/RESTRICTIVE (permissive column is text, not boolean)
    permissive_text := CASE WHEN r.permissive = 'PERMISSIVE' THEN 'AS PERMISSIVE' ELSE 'AS RESTRICTIVE' END;
