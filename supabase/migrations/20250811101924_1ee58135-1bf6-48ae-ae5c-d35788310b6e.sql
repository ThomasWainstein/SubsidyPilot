...
SELECT
  ...
  CASE 
    WHEN status = 'completed' AND tables_extracted = true AND table_count > 0 THEN 'success'
...
-- Create optimized index for Phase D queries (already exists but ensuring it's documented)
-- This speeds up dashboards and analytics queries
