...
ENV_VAR_MAPPINGS = {
    ...
    'NEXT_PUBLIC_SUPABASE_ANON': ['NEXT_PUBLIC_SUPABASE_ANON_KEY', 'NEXT_PUBLIC_SUPABASE_ANON', 'SUPABASE_ANON_KEY', 'SUPABASE_ANON'],
    'SUPABASE_ANON_KEY': ['NEXT_PUBLIC_SUPABASE_ANON_KEY', 'NEXT_PUBLIC_SUPABASE_ANON', 'SUPABASE_ANON_KEY', 'SUPABASE_ANON'],
