    ...
    const loadRecommendations = async () => {
      ...
      try {
        ...
        const topRecommendations = [
          ...allRecommendations.quickWins.slice(0, 2),
          ...allRecommendations.highValue.slice(0, 2),
            ...
            {error ? (
              ...
              <>
                ...
                <p className="text-sm text-muted-foreground">
                  {searchQuery 
                    ? `No personalized recommendations match "${searchQuery}"`
  ...
  return (
    <Card className={className}>
      <CardHeader className="pb-3">
        ...
        <p className="text-sm text-muted-foreground">
          Based on your farm profile and preferences
        </p>
      </CardHeader>
      <CardContent className="space-y-3">
...
}> = ({ recommendation: rec, onViewRecommendation, getCategoryIcon }) => {
