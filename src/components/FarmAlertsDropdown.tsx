...
const FarmAlertsDropdown = ({
      ...
      <div className="relative" ref={alertsRef}>
        ...
        {isOpen && (
          <div className="fixed inset-x-4 top-20 z-50">
            <Card className="backdrop-blur-sm border-gray-100 dark:border-gray-700 animate-in fade-in slide-in-from-top-2 w-full max-h-[400px] overflow-y-auto dark:bg-slate-800 dark:text-white">
              <AlertContent 
                setIsOpen={setIsOpen}
                t={t}
  ...
  return (
    <Popover open={isOpen} onOpenChange={setIsOpen}>
      ...
      <PopoverContent className="w-[280px] p-0 shadow-xl backdrop-blur-sm border-gray-100 dark:border-gray-700 dark:bg-slate-800 dark:text-white" align="end">
        <AlertContent 
          setIsOpen={setIsOpen}
          t={t}
          showNewSubsidyBadge={showNewSubsidyBadge}
...
// Extract Alert Content to its own component for reuse
const AlertContent = ({ 
  setIsOpen, 
  t, 
  showNewSubsidyBadge, 
